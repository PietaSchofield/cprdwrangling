...
rmarkdown::render(
 input=file.path(Sys.getenv("HOME"),"GitLab","github","cprdwrangling","index.Rmd"),
 output_file=outfile
 )
system2("xdg-open",args=outfile,wait=FALSE)
outfile <- file.path("/srv","http","uol","cprdwrangling","index.html")
...
```{r build-it_github, comment=NA,eval=F,echo=F}
#
# Render for GitHub
#
