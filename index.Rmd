...
```{r plotit_R, comment=NA, echo=tohtml, out.width="100%",warning=F,message=F}
...
```{r plotit_2_R, comment=NA, echo=tohtml, out.width="100%",warning=F,message=F}
print(dementia_trends_plot)
```
</div>
...
system2("xdg-open",args=readme,wait=FALSE)
```
